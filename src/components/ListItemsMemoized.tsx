...
import ListItemsMemoized_Code from './ListItemsMemoized_Code';
...
ListItemsMemoized.displayName = "ListItemsMemoized";
...
ListItem.displayName = "ListItemMemoized";